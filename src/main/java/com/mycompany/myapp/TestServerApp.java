...
public class TestServerApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TestServerApp.class);

    private final Environment env;

    public TestServerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes test_server.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestServerApp.class);
